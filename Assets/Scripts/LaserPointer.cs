...
public class LaserPointer : MonoBehaviour
{
	...
	public LayerMask notTeleportMask;//Annule le deplacement quand le pointeur passe decu
    ...
    void Update()
    {
        ...
        if (Controller.GetPress(SteamVR_Controller.ButtonMask.Touchpad))
        {
			...
			if (Physics.Raycast(trackedObj.transform.position, transform.forward, out hit, 100, notTeleportMask))
			{
				//hitPoint = hit.point;
